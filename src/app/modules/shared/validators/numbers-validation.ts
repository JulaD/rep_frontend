...
/*
 Acepta un numero entero >= 0 con un + opcional y un
 separador decimal seguido de ceros opcional
 */
export const numeroEnteroPositivoValidator: ValidatorFn = 
...
/*
 ...
 Acepta 
*/
export const numeroFloatValidator: ValidatorFn =
